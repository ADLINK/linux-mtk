...
SND_SOC_DAPM_DAC("Left DAC", "Playback", WM8960_POWER2, 8, 1),
SND_SOC_DAPM_DAC("Right DAC", "Playback", WM8960_POWER2, 7, 1),

SND_SOC_DAPM_MIXER("Left Output Mixer", WM8960_POWER3, 3, 1,
	&wm8960_loutput_mixer[0],
	ARRAY_SIZE(wm8960_loutput_mixer)),
SND_SOC_DAPM_MIXER("Right Output Mixer", WM8960_POWER3, 2, 1,
	&wm8960_routput_mixer[0],
	ARRAY_SIZE(wm8960_routput_mixer)),

SND_SOC_DAPM_PGA("LOUT1 PGA", WM8960_POWER2, 6, 1, NULL, 0),
SND_SOC_DAPM_PGA("ROUT1 PGA", WM8960_POWER2, 5, 1, NULL, 0),
...
static int wm8960_unmute(struct snd_soc_component *component)
{
	//snd_soc_component_write(component, WM8960_DACCTL1, 0x8); //mute for loopback
	snd_soc_component_write(component, WM8960_DACCTL1, 0x00);
        //snd_soc_component_update_bits(component, WM8960_POWER1, 0x7F, 0x7F);
	snd_soc_component_write(component, WM8960_POWER1, 0x0FE);
	snd_soc_component_write(component, WM8960_LINPATH, 0x128);
	snd_soc_component_write(component, WM8960_RINPATH, 0x128);
	snd_soc_component_write(component, WM8960_POWER2, 0x1FB);
	snd_soc_component_write(component, WM8960_POWER3, 0x03C);
	snd_soc_component_write(component, WM8960_ADDCTL3, 0x0);
	snd_soc_component_write(component, WM8960_ADDCTL4, 0x2);
	...
	snd_soc_component_write(component, WM8960_CLASSD1, 0x0F7);
	snd_soc_component_write(component, WM8960_LDAC, 0x1FF);
	snd_soc_component_write(component, WM8960_RDAC, 0x1FF);
	snd_soc_component_write(component, WM8960_LOUT1, 0x17F);
	snd_soc_component_write(component, WM8960_ROUT1, 0x17F);
	//snd_soc_component_write(component, WM8960_IFACE2, 0x41); //set For loopback
			    ...
			    const struct i2c_device_id *id)
{
	...
	regmap_update_bits(wm8960->regmap, WM8960_ADDCTL2, 3 << 5, 0 << 5);
